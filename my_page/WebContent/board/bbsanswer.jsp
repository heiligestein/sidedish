...
<script type="text/javascript">
	$(document).ready(function (){
		...
		$(document).on("click","#cls_answerwrite",function (){
			$("#frm_insert").submit();	
			...
			<div id="bbsData_container">
				<div id = "page_body">
					<div id="bbs_table_write">
						<form role="form" action="answerinsertsave.sidedish" id="frm_insert" name="frm_insert" method="post" enctype="multipart/form-data" style="position: relative;">
							<input id="bno" name="bno" type="hidden" value="${boardview.bno}">
							<table style="border-bottom: 1px solid #dddddd;">
								...
								<tbody>
									...
									<th><div>제목</div></td>
										<td>
										<div id="write_title">
											<input id="input_title" type="text" name="title" class="MS_input_txt input_style2" value="RE: ${boardview.title}" readonly="readonly">
									...
									<th><div>내용</div></td>
										<td>
										<div id="text_edit">
											<textarea id="input_content" name="content" wrap="off" class="MS_input_txt" style="font-family:굴림체;" >${boardview.content}</textarea>
										</div>
										</td>
									</tr>
						...
						<div class="bbs_link bbs_link_btm">
							<div style="text-align: right; float: right;">
								<a id="cls_answerwrite" href="#"><div style="width: 100px; height: 50px; font-size: 15px; background-color: #88b04b; text-align: center;">
									<p style="color: #fff; line-height: 50px;">답글쓰기</p>
								</div></a>
